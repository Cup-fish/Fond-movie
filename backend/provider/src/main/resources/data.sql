...
(43, '再见哥斯拉',   'Goodbye Godzilla',      'https://picsum.photos/seed/movie43/180/250', 0, '渡边谦,长�的浩二',   '科幻,灾难',   '日本',     138, '2026年5月28日上映', '哥斯拉消失三十年后再次出现，这一次它要面对的不是人类的武器，而是另一个远古巨兽。', 58900, '', '[]', 0, NULL, '5月28日 周四', 0, 0, 18),
